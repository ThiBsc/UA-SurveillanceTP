...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='Table regroupant les examens';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `EXAMEN` VALUES (1,'2017-12-02 00:00:00','2h',2,1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='Table des évenements suspects\nexemple:\nexamen d''id 1, l''étudiant Prenom Nom à un évenement de type network.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `ua_surveillance`.`EXAMEN_has_VIDEO_PATH` (
  ...
  `etu_hostname` VARCHAR(30) NULL,
  `etu_ip` VARCHAR(20) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_EXAMEN_has_VIDEO_PATH_EXAMEN1_idx` (`EXAMEN_id` ASC),
  INDEX `fk_EXAMEN_has_VIDEO_PATH_VIDEO_PATH1_idx` (`VIDEO_PATH_nom` ASC),
  CONSTRAINT `fk_EXAMEN_has_VIDEO_PATH_EXAMEN1`
    FOREIGN KEY (`EXAMEN_id`)
    REFERENCES `ua_surveillance`.`EXAMEN` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_EXAMEN_has_VIDEO_PATH_VIDEO_PATH1`
    FOREIGN KEY (`VIDEO_PATH_nom`)
    REFERENCES `ua_surveillance`.`VIDEO_PATH` (`nom`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-12-02 17:38:18
